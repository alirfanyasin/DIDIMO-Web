...
<section class="container h-100 " id="dashboard">
  <div class="row mt-5 mb-4">
    <h2 class="text-center fw-semibold">Halo, {{ auth()->user()->name }} <br>Selamat Datang di <span class="text-main">DIDIMO</span>
    </h2>
  </div>
          ...
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-6">
              <h5 class="fs-6 fw-semibold ms-0">
                {{ date('F', strtotime($next_inspection)) }}<br>{{ date('Y', strtotime($next_inspection)) }}
              </h5>
              </h5>
            </div>
            @else
        ...
        <div class="card-body">
          ...
          <div class="mt-5">
            <div class="d-flex justify-content-beetwen mb-3">
              <div class="bg-warning rounded-circle mr-2 d-flex align-items-center justify-content-center" style="width: 50px; height:50px;">
            ...
            <div class="d-flex justify-content-beetwen mb-3">
              <div class="bg-primary text-white rounded-circle mr-2 d-flex align-items-center justify-content-center" style="width: 50px; height:50px;">
                <i class="fa-solid fa-bowl-rice fs-3"></i>
              </div>
              <div class="mx-2"></div>
              <div>
            ...
            <div class="d-flex justify-content-beetwen mb-3">
              <div class="bg-danger text-white rounded-circle mr-2 d-flex align-items-center justify-content-center" style="width: 50px; height:50px;">
                <i class="fa-solid fa-bowl-rice fs-3"></i>
              </div>
              <div class="mx-2"></div>
              <div>

...
<section class="container h-100 " id="dashboard">
    <div class="row mt-5 mb-4">
        <h2 class="text-center fw-semibold">Halo, Irfan Yasin<br>Selamat Datang di <span class="text-main">DIDIMO</span></h2>
    </div>
            ...
            <div class="card border-white">
                ...
                <div class="profile d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('assets/img/Ellipse.png') }}" alt="" width="40px" height="40px" class="ms-3 rounded-pill">
                        <div class="mx-3">
                ...
                <div class="profile d-flex align-items-center">
                    <div class="mt-3 d-flex align-items-center">
                        <img src="{{ asset('assets/img/Ellipse.png') }}" width="40px" height="40px" class="ms-3  rounded-pill">
                        <div class="mx-3">
                            <small class="d-block">Lorem ipsum</small>
                            <small class="text-secondary">Lorem ipsum dolor sit.</small>
                        </div>
